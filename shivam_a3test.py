...
def test_complement():
    ...
    print('Testing test_complement ended')
...
def test_str5_color():
    ...
    # test for str5_hsv (add two)

    text = a3.str5_hsv(introcs.HSV(220.0, 0.99999, 0.65999))
    introcs.assert_equals('(220.0, 1.000, 0.660)',text)


    text = a3.str5_hsv(introcs.HSV(220.0, 1e-9, 0.65999))
    introcs.assert_equals('(220.0, 0.000, 0.660)',text)


    print(' Testing test_str5_color ended')
...
def test_rgb_to_hsv():
    ...
    rgb = introcs.RGB(120,240,0)          # M ==  g
    hsv = a3.rgb_to_hsv(rgb)
    introcs.assert_equals(90.0, round(hsv.hue,3))
    introcs.assert_equals(1.0, round(hsv.saturation,3))
    introcs.assert_equals(0.941, round(hsv.value,3))
    ...
    rgb = introcs.RGB(240,120,0)              # M == r and g >= b
    hsv = a3.rgb_to_hsv(rgb)
    ...
    rgb = introcs.RGB(240,0,120)                  # M == r and g < b
    hsv = a3.rgb_to_hsv(rgb)
    introcs.assert_equals(330.0, round(hsv.hue,3))
    introcs.assert_equals(1.0, round(hsv.saturation,3))
    introcs.assert_equals(0.941, round(hsv.value,3))
    ...
    rgb = introcs.RGB(120,0,240)                  # M == b
    hsv = a3.rgb_to_hsv(rgb)
    introcs.assert_equals(270.0, round(hsv.hue,3))
    introcs.assert_equals(1.0, round(hsv.saturation,3))
    introcs.assert_equals(0.941, round(hsv.value,3))
    ...
    print('testing _rgb_to_hsv ended')
...
def test_hsv_to_rgb():
    ...
    hsv = introcs.HSV(50.0,0.5,0.6)                  # h == 0
    rgb = a3.hsv_to_rgb(hsv)

    introcs.assert_equals(153, round(rgb.red,3))
    introcs.assert_equals(140, round(rgb.green,3))
    introcs.assert_equals(76, round(rgb.blue,3))



    hsv = introcs.HSV(61.0,0.5,0.6)                  # h == 1
    rgb = a3.hsv_to_rgb(hsv)

    introcs.assert_equals(152, round(rgb.red,3))
    introcs.assert_equals(153, round(rgb.green,3))
    introcs.assert_equals(76, round(rgb.blue,3))



    hsv = introcs.HSV(125.0,0.4,0.6)                  # h == 2
    rgb = a3.hsv_to_rgb(hsv)

    introcs.assert_equals(92, round(rgb.red,3))
    introcs.assert_equals(153, round(rgb.green,3))
    introcs.assert_equals(97, round(rgb.blue,3))


    hsv = introcs.HSV(245.0,0.5,0.6)                  # h == 4
    rgb = a3.hsv_to_rgb(hsv)

    introcs.assert_equals(83, round(rgb.red,3))
    introcs.assert_equals(76, round(rgb.green,3))
    introcs.assert_equals(153, round(rgb.blue,3))



    hsv = introcs.HSV(190.0,0.3,0.5)                  # h == 3
    rgb = a3.hsv_to_rgb(hsv)

    introcs.assert_equals(89, round(rgb.red,3))
    introcs.assert_equals(121, round(rgb.green,3))
    introcs.assert_equals(128, round(rgb.blue,3))



    hsv = introcs.HSV(315.0,0.4,0.6)                  # h == 5
    rgb = a3.hsv_to_rgb(hsv)

    introcs.assert_equals(153, round(rgb.red,3))
    introcs.assert_equals(92, round(rgb.green,3))
    introcs.assert_equals(138, round(rgb.blue,3))
...
def test_contrast_rgb():
    ...
    # Add two more tests
    # positive contrast
    rgb = introcs.RGB(120,60,100)
    hsv = a3.contrast_rgb(rgb,0.5)
    introcs.assert_equals(105, rgb.red)
    introcs.assert_equals(20,  rgb.green)
    ...
    # normal contrast
    rgb = introcs.RGB(120,60,100)
    hsv = a3.contrast_rgb(rgb,0)
    introcs.assert_equals(120, rgb.red)
    introcs.assert_equals(60,  rgb.green)
    introcs.assert_equals(100, rgb.blue)
